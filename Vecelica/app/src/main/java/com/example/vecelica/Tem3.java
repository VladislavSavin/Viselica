...
public class Tem3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(j == 1){
            ...
            Name2.setText("Одно из мифических существ");
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  6){
                        switch (view.getId()){
                            case R.id.butn2: textView1.setText("Д"); WinOrLose.setText("Все верно"); btn2.setEnabled(false); ;b[0] +=1 ;break;
                            case R.id.butn12: textView2.setText("Р"); WinOrLose.setText("Все верно"); btn12.setEnabled(false); b[0] +=1;break;
                            case R.id.butn1: textView3.setText("А"); WinOrLose.setText("Все верно"); btn1.setEnabled(false);b[0] +=1;break;
                            case R.id.butn7: textView4.setText("К"); WinOrLose.setText("Все верно");btn7.setEnabled(false);b[0] +=1;break;
                            case R.id.butn11: textView5.setText("О"); WinOrLose.setText("Все верно");btn11.setEnabled(false);b[0] +=1;break;
                            case R.id.butn10: textView6.setText("Н"); WinOrLose.setText("Все верно");btn10.setEnabled(false);b[0] +=1;break;
                        }
        ...
        if(j == 2){
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  4){
                        switch (view.getId()){
                            case R.id.butn13: textView2.setText("С"); WinOrLose.setText("Все верно");btn13.setEnabled(false); b[0] +=1; break;
                            case R.id.butn8: textView3.setText("Л"); WinOrLose.setText("Все верно");btn8.setEnabled(false); b[0] +=1; break;
                            case R.id.butn11: textView4.setText("О"); WinOrLose.setText("Все верно"); b[0] +=1;btn11.setEnabled(false); break;
        ...
        if(j == 3){
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  3){
                        switch (view.getId()){
                            case R.id.butn8: textView2.setText("Л"); WinOrLose.setText("Все верно");btn8.setEnabled(false);b[0] +=1; break;
                            case R.id.butn1: textView3.setText("А"); textView5.setText("А");WinOrLose.setText("Все верно");btn1.setEnabled(false);b[0] +=1;  break;
                            case R.id.butn9: textView4.setText("М"); WinOrLose.setText("Все верно");btn9.setEnabled(false);b[0] +=1; break;
                        }
                        //------------------------------------------------------------------------------
                        switch (view.getId()){
                            case R.id.butn2: f[0]++; WinOrLose.setText("Неверно"); btn2.setEnabled(false);break;
        ...
        if(j == 4){
            ...
            Name2.setText("Как лиса только более ласково");
            View.OnClickListener onClickListener = new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    //------------------------------------------------------------------------------Нужные буквы для города МОСКВА
                    ...
                    if(f[0] <= 5 && b[0] <  5){
                        switch (view.getId()){
                            case R.id.butn8: textView1.setText("Л"); WinOrLose.setText("Все верно");btn8.setEnabled(false);b[0] +=1; break;
                            case R.id.butn6: textView2.setText("И"); textView4.setText("И"); WinOrLose.setText("Все верно");btn6.setEnabled(false);b[0] +=1;  break;
                            case R.id.butn13: textView3.setText("С"); WinOrLose.setText("Все верно");btn13.setEnabled(false);b[0] +=1; break;
                            case R.id.butn16: textView5.setText("Ц"); WinOrLose.setText("Все верно");btn16.setEnabled(false);b[0] +=1; break;
        ...
        if(j == 5){
            ...
            Name2.setText("Ленивое морское животное");
            View.OnClickListener onClickListener = new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  6){
                        switch (view.getId()){
                            case R.id.butn14: textView1.setText("Т"); WinOrLose.setText("Все верно");btn14.setEnabled(false);b[0] +=1; break;
                            case R.id.butn18: textView2.setText("Ю"); WinOrLose.setText("Все верно");btn18.setEnabled(false);b[0] +=1;  break;
                            case R.id.butn8: textView3.setText("Л"); WinOrLose.setText("Все верно");btn8.setEnabled(false);b[0] +=1; break;
                            case R.id.butn3: textView4.setText("Е"); WinOrLose.setText("Все верно");btn3.setEnabled(false);b[0] +=1; break;
                            case R.id.butn10: textView5.setText("Н"); WinOrLose.setText("Все верно");btn10.setEnabled(false);b[0] +=1; break;
                            case R.id.butn17: textView6.setText("Ь"); WinOrLose.setText("Все верно");btn17.setEnabled(false);b[0] +=1; break;
        ...
        last1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    Intent intent = new Intent(Tem3.this, ChoseTem.class);
