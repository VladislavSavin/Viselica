...
public class Tem2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(j == 1){
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  5){
                        switch (view.getId()){
                            case R.id.butn9: textView1.setText("П"); WinOrLose.setText("Все верно"); btn9.setEnabled(false); ;b[0] +=1 ;break;
                            case R.id.butn1: textView2.setText("А"); WinOrLose.setText("Все верно"); textView6.setText("А"); btn1.setEnabled(false); b[0] +=1;break;
                            case R.id.butn6: textView3.setText("Л"); WinOrLose.setText("Все верно"); btn6.setEnabled(false);b[0] +=1;break;
                            case R.id.butn16: textView4.setText("Ь"); WinOrLose.setText("Все верно");btn16.setEnabled(false);b[0] +=1;break;
                            case R.id.butn7: textView5.setText("М"); WinOrLose.setText("Все верно");btn7.setEnabled(false);b[0] +=1;break;
                        }
        ...
        if(j == 2){
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  3){
                        switch (view.getId()){
                            case R.id.butn7: textView2.setText("М"); WinOrLose.setText("Все верно");btn7.setEnabled(false); b[0] +=1; break;
                            case R.id.butn8: textView3.setText("О"); WinOrLose.setText("Все верно");btn8.setEnabled(false); b[0] +=1; break;
                            case R.id.butn12: textView4.setText("Х"); WinOrLose.setText("Все верно");btn12.setEnabled(false); b[0] +=1; break;
        ...
        if(j == 3){
            ...
            Name2.setText("Прочнее твоих нервов");
            View.OnClickListener onClickListener = new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    //------------------------------------------------------------------------------Нужные буквы для города МОСКВА
                    ...
                    if(f[0] <= 5 && b[0] <  3){
                        switch (view.getId()){
                            case R.id.butn3: textView2.setText("Д"); WinOrLose.setText("Все верно");btn3.setEnabled(false);b[0] +=1; break;
                            case R.id.butn11: textView3.setText("У"); WinOrLose.setText("Все верно");btn11.setEnabled(false);b[0] +=1;  break;
                            case R.id.butn2: textView4.setText("Б"); WinOrLose.setText("Все верно");btn2.setEnabled(false);b[0] +=1; break;
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  5){
                        switch (view.getId()){
                            ...
                            case R.id.butn4: textView2.setText("Е"); textView4.setText("Е"); WinOrLose.setText("Все верно");btn4.setEnabled(false);b[0] +=1;  break;
                            case R.id.butn10: textView3.setText("Р"); WinOrLose.setText("Все верно");btn10.setEnabled(false);b[0] +=1; break;
                            case R.id.butn5: textView5.setText("З"); WinOrLose.setText("Все верно");btn5.setEnabled(false);b[0] +=1; break;
        ...
        if(j == 5){
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(f[0] <= 5 && b[0] <  3){
                        switch (view.getId()){
                            case R.id.butn4: textView2.setText("Е"); WinOrLose.setText("Все верно");btn4.setEnabled(false);b[0] +=1; break;
                            case R.id.butn6: textView3.setText("Л"); WinOrLose.setText("Все верно");btn6.setEnabled(false);b[0] +=1;  break;
                            case R.id.butn16: textView4.setText("Ь"); WinOrLose.setText("Все верно");btn16.setEnabled(false);b[0] +=1; break;
                        }
        ...
        TextView last2 = (TextView) findViewById(R.id.last2);
        last2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try{
                    Intent intent = new Intent(Tem2.this, ChoseTem.class);
    ...
    public void onBackPressed(){
        try {
            Intent intent = new Intent(Tem2.this, MainActivity.class);
            startActivity(intent); finish();
        } catch (Exception e){
